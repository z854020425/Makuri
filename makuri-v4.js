...
async function main(){
	...
	"🤣": ['百万个吻', '骗赖', '香水有毒', '通天大道宽又阔', '你跟我比夹夹', 'TMD我爱你', '闹啥子嘛闹', '810975', '忐忑', '蕉蕉'],
	"儿歌": ['小鲤鱼历险记', '我爱洗澡', '勇气大爆发', '我会自己上厕所', '加油鸭', '巴啦啦小魔仙', '小小鹿', '别看我是一只羊', '宝贝宝贝', '白龙马', '葫芦娃', '大家一起喜羊羊', '天上掉下个猪八戒', '快乐小孩', '少年英雄小哪吒', '我为厨艺狂', '永远的奥特曼'],
	"😭": ['嘉宾', '阿拉斯加海湾', '就让这大雨全都落下', '心做し', '雨爱', '成全', '连名带姓', '有一种悲伤', '僕が死のうと思ったのは', '北极星的眼泪', '到此为止', '可惜不是你', '刻在我心底的名字', '空心', '浪费', '你瞒我瞒', '人质', '傻子', '说谎', '说散就散', '兔子先生', '我很快乐', '想自由', '一个人的北京', 'カワキヲアメク', '大眠', '你就不要想起我']
	};
